...
var PLAYER_UNITS = {
  ...
  jiro: {
    n:'ウィリアム', e:'🧐', cost:40, hp:50, dmg:40, spd:40, rng:150, ar:1.6,
  ...
  don: {
    n:'チャールズ', e:'🤯', cost:50, hp:120, dmg:100, spd:30, rng:120, ar:1.5, area:10,
    type:'ground', targets:'both', cd:5.5, size:1.0, rew:1, zone:'own', unlockCost:400,
    attr:'humanoid', affinity:'undead', crt:2.0
  },
  biri: {
    n:'ジョージ', e:'🤩', cost:60, hp:90, dmg:30, spd:30, rng:120, ar:1.2, area:5,
  ...
  akuma: {
    n:'ベンジャミン', e:'😎', cost:500, hp:1000, dmg:300, spd:8, rng:100, ar:5.0, area:80,
